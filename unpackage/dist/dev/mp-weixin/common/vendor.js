...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"v-monitor-app","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
commBnsConfig.funcGetCurEnvirCfg = function () {
  ...
  switch (envType) {
    ...
    case "Dvlp":
      ...
      break;
    case "Product":
      config.defaultUrl = "https://".concat(host);
      break;
    case "Test":
...
exports.default = _default;
var _callCheckVersion = _interopRequireDefault(__webpack_require__(/*! ./call-check-version */ 48));
// 推荐再App.vue中使用
...
var _asyncToGenerator2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/asyncToGenerator */ 31));
var _defineProperty2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/defineProperty */ 11));
var _commBnsConfig = _interopRequireDefault(__webpack_require__(/*! ./commBnsConfig.js */ 44));
var _utilUniHttpRequest = _interopRequireDefault(__webpack_require__(/*! ../commFrmk/commApp/uniHttpRequestUtil/utilUniHttpRequest.js */ 54));
var _utilSignBaseSHA = _interopRequireDefault(__webpack_require__(/*! ../commFrmk/commApp/commAppHashUtil/utilSignBaseSHA1.js */ 55));
var _uuid = _interopRequireDefault(__webpack_require__(/*! uuid */ 57));
var _qs = _interopRequireDefault(__webpack_require__(/*! qs */ 62));
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? ownKeys(Object(source), !0).forEach(function (key) { (0, _defineProperty2.default)(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
...
exports.default = void 0;
var _utilSHA = _interopRequireDefault(__webpack_require__(/*! ./utilSHA1.js */ 56));
/************************************************************************************************************
 * 实现功能:基于SHA1的API签名算法
 * 创    建:张洪波   2020年05月20日
 * 最近更新: 张洪波   2020年05月20日
...
var v4 = __webpack_require__(/*! ./v4 */ 61);
...
var rng = __webpack_require__(/*! ./lib/rng */ 59);
var bytesToUuid = __webpack_require__(/*! ./lib/bytesToUuid */ 60);
...
var stringify = __webpack_require__(/*! ./stringify */ 63);
...
var getSideChannel = __webpack_require__(/*! side-channel */ 64);
...
var GetIntrinsic = __webpack_require__(/*! get-intrinsic */ 65);
var callBound = __webpack_require__(/*! call-bind/callBound */ 71);
var inspect = __webpack_require__(/*! object-inspect */ 73);
...
var bind = __webpack_require__(/*! function-bind */ 68);
var hasOwn = __webpack_require__(/*! has */ 70);
...
var hasSymbolSham = __webpack_require__(/*! ./shams */ 67);
...
var utilInspect = __webpack_require__(/*! ./util.inspect */ 74);
...
exports.default = void 0;
var _commBnsUniHttpRequest = _interopRequireDefault(__webpack_require__(/*! @/commBns/commBnsUniHttpRequest */ 53));
...
var Base64 = __webpack_require__(/*! js-base64 */ 85).Base64;
...
function getCaptcha(phone) {
  return _commBnsUniHttpRequest.default.FuncBnsHttpRequestWithGet("/sms/captcha", {
    phone: phone
  }, {
    'Content-Type': 'application/json',
    Authorization: 'Basic' + ' ' + Base64.encode('app' + ':' + 'password')
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/buffer/index.js */ 86).Buffer))
...
var base64 = __webpack_require__(/*! base64-js */ 87)
var ieee754 = __webpack_require__(/*! ieee754 */ 88)
